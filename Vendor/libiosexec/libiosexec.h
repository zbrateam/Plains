...
#  if (TARGET_OS_IPHONE && !TARGET_OS_SIMULATOR && !TARGET_OS_MACCATALYST) && !defined(LIBIOSEXEC_INTERNAL)
...
#  endif // (TARGET_OS_IPHONE && !TARGET_OS_SIMULATOR && !TARGET_OS_MACCATALYST) && !defined(LIBIOSEXEC_INTERNAL)
#endif // __APPLE__
